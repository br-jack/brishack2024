...
export const insertInstitution = async (
  username: string,
  password: string,
  name: string
) => {
...
export const insertMedUser = async (
  username: string,
  password: string,
  name: string,
  instUsername: string
...
export const insertCivUser = async (
  username: string,
  name: string,
  number: string,
  password: string,
  infoPublicallyAvailable: boolean,
  dateOfBirth: Date,
  bloodType: string,
  organDonor: boolean
) => {
...
export const updateUserProfile = async (
  ...
  newName: string,
  newNumber: string,
  newInfoPublicallyAvailable: boolean,
  newPassword: string,
  newDateOfBirth: Date,
  newBloodType: string,
  newOrganDonor: boolean
) => {
...
export const insertInformation = async (
  username: string,
  infoTitle: string,
  infoDes: string
) => {
...
export const verifyCivUser = async (
